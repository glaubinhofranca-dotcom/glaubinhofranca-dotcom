...
### Senior Data Professional | GenAI, AI Engineering & Strategy

I transform complex data (**Text, Tables, Images & Graphs**) into strategic decisions using **Python**, **Autonomous Agents**, and **Advanced Analytics**.
Currently focused on building **Sovereign AI Systems** (Local LLMs), **Real-Time Architectures**, and **End-to-End Lakehouse Platforms** for the Financial and Insurance sectors.
...
3.  🕸️ **[AML Graph Fraud Detector](https://github.com/glaubinhofranca-dotcom/21_AML_Graph_Fraud_Detection):** A forensic tool using **NetworkX** and **Unsupervised Learning** (Isolation Forest) to detect complex money laundering rings (Smurfing) in transaction networks.

---

### 🛠️ **Tech Stack**
* **Languages:** Python, SQL, DAX.
* **Engineering:** **Apache Airflow**, **Docker**, **Kafka**, MinIO (S3), PostgreSQL.
* **Generative AI:** **Llama-3 (Local GGUF)**, RAG (FAISS), LangChain, CrewAI.
* **Advanced Analytics:** **NetworkX (Graph Theory)**, Scikit-Learn (Anomaly Detection), YOLOv8.
* **Architecture:** Lakehouse (Medallion), Event-Driven, Microservices.
