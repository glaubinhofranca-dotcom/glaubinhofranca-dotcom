...
Currently focused on building **Multi-Agent Systems** and **RAG Applications** for the Financial Sector.
...
2.  🤖 **[FinBot (GenAI Agent)](https://github.com/glaubinhofranca-dotcom/00_GenAI_Financial_Analyst):** A Financial Analyst Chatbot that reads Wall Street 10-K Reports using RAG & OpenAI.
3.  🗣️ **[Talk-to-Data (Text-to-SQL)](https://github.com/glaubinhofranca-dotcom/14_AI_Agent_Text_to_SQL):** An AI Agent that translates English questions into SQL queries to analyze databases instantly.
